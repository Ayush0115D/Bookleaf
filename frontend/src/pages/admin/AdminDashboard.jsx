  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Manage support tickets, AI classifications, and author communications</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link
          to="/admin/tickets"
          className="group relative bg-white dark:bg-navy-800 rounded-2xl border border-gray-100 dark:border-navy-700 shadow-sm hover:shadow-xl hover:border-gold-500/30 transition-all duration-300 overflow-hidden"
        >
        ...
        <div className="bg-white dark:bg-navy-800 rounded-2xl border border-gray-100 dark:border-navy-700 shadow-sm p-6 sm:p-8">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-teal-500/10 text-teal-400 mb-5">
            <BotIcon className="w-8 h-8" />
          </div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">AI-Powered Features</h3>
